import React, {
  ...
  const ClapCount = ({style: userStyles = {}}) => {
    ...
    return (
      <span style={userStyles} ref={setRef} data-refkey="clapCountRef" className={styles.count}>
        +{count}
      </span>
    );
  };
  const CountTotal = ({style: userStyles = {}}) => {
    ...
    return (
      <span style={userStyles} ref={setRef} data-refkey="clapTotalRef" className={styles.total}>
        {countTotal}
      </span>
    );
  };
